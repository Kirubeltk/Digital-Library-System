 ...
 <li>
                           ...
                           <li>
                            ...
                            <!-- <li><a href="reg-students.php">Reg Students</a></li> -->
							 <li><a href="add-librarian-user.php">Add Librarian</a></li>
							 <li><a href="add-admin-user.php">Add Admin</a></li>
							 
						<!--	 <li> 
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Add User <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-admin-user.php">Add Admin User</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add-librarian-user.php"">Add Librarian</a></li>
									 <li role="presentation"><a role="menuitem" tabindex="-1" href="add-student-user.php">Add Students</a></li>
                                </ul>
                            </li> -->
