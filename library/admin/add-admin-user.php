...
$adminuser=$_POST['adminuser1'];
$adminemail=$_POST['adminemail1'];
$username=$_POST['username1'];
$password=md5($_POST['password1']); 
$sql="INSERT INTO  admin(FullName,AdminEmail,UserName,Password) VALUES(:adminuser, :adminemail, :username, :password)";
...
if($lastInsertId)
{
echo '<script>alert("You Add admin user successfully ")</script>';
}
else 
{
...
<input class="form-control" type="text" name="adminuser1" autocomplete="off"  required />
</div>
<div class="form-group">
<label>Admin Email</label>
<input class="form-control" type="text" name="adminemail1" autocomplete="off"  required />
</div>
<div class="form-group">
<label>Admin Uername</label>
