...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2021 at 08:18 AM
...
CREATE TABLE IF NOT EXISTS `o` (
  `y` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `i` int(100) NOT NULL
...
INSERT INTO `o` (`y`, `i`) VALUES
(NULL, 10),
('2021-02-10 11:13:31', 454);
...
CREATE TABLE IF NOT EXISTS `t` (
  `y` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tblguest` (`id`, `StudentId`, `FullName`, `EmailId`, `MobileNumber`, `Password`, `Status`, `RegDate`, `UpdationDate`) VALUES
(11, 'SID012', 'Kirubel', 'sdgsd@gmail.com', '21646', 'e10adc3949ba59abbe56e057f20f883e', 1, '2021-02-09 07:07:06', NULL),
(12, 'SID013', 'Adane', 'adnae@gmail.com', '464646', 'e10adc3949ba59abbe56e057f20f883e', 1, '2021-02-09 15:56:55', NULL);
